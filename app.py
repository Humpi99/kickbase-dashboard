...
def load_real_budget(
    api,
    league_id,
):
    """Lädt den eigenen Kontostand."""
    try:
        value, _ = (
            api.get_budget(
                league_id
